...
import { menu } from '../../../data/menu';
  ...
  const DashboardPage = ({ searchParams }: { searchParams: { category?: string } }) => {
        ...
        <div className='container'>
          ...
          <div className='text-center mb-20 max-w-[400px] mx-auto'>
            ...
            <div className="mt-4 mb-6 flex justify-center space-x-4">
                    <Link href="/manager/menu" className={`text-soft-brown ${!category ? 'font-bold' : ''}`}>All</Link>
                    <Link href="/manager/menu?category=makanan" className={`text-soft-brown ${category === 'makanan' ? 'font-bold' : ''}`}>makanan</Link>
                    <Link href="/manager/menu?category=minuman" className={`text-soft-brown ${category === 'minuman' ? 'font-bold' : ''}`}>minuman</Link>
                </div>
